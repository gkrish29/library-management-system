<?php 
    ...
    $sql = " SELECT books.book_id, books.book_title,books.genre, authors.author_name
    FROM books
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()){
                   echo "<tr>
                        ...
                        <td>".$row['genre']."</td>";
                       echo "<td><button class='delete-button'><a href='deletebook.php?bn=" . $row['book_id'] . "'>Delete</a></button></td>";
