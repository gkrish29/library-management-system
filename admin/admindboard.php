<?php
    ...
    $sql1 = "SELECT * FROM admins WHERE username = '$username';";
        ...
        $sql2 = "SELECT count(*) as bcount FROM books ";
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #fdf6e3;">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-center">
                <li class="nav-item">
                    <a class="nav-link tcolor" href="admin_dashboard.php">Dashboard</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle tcolor" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Books
                    </a>
                    <ul class="dropdown-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link tcolor" href="issue_book.php">Issue Book</a>
                </li>
            </ul>
        </div>
    </nav><br>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card bg-light dashboard-card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Total Users: <?php  echo getuser_count();?></p>
                        <a class="btn btn-danger" href="viewuser.php" target="_blank">View Registered Users</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card bg-light dashboard-card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Total Books: <?php  echo $bcount; ?></p>
                        <a class="btn btn-success" href="viewbook.php" target="_blank">View All Books</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
